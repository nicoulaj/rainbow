...
from rainbow.ansi import ANSI_BACKGROUND_BLUE, ANSI_BACKGROUND_CYAN, ANSI_BACKGROUND_GREEN, ANSI_BACKGROUND_MAGENTA, \
    ANSI_BACKGROUND_RED, ANSI_BACKGROUND_RESET, ANSI_BACKGROUND_YELLOW, ANSI_BACKGROUND_LIGHT_RED, \
    ANSI_BACKGROUND_LIGHT_GREEN, ANSI_BACKGROUND_LIGHT_YELLOW, ANSI_BACKGROUND_LIGHT_BLUE, ANSI_BACKGROUND_LIGHT_CYAN, \
    ANSI_BLINK, ANSI_BLINK_RAPID, ANSI_BOLD, ANSI_FAINT, ANSI_FOREGROUND_BLUE, ANSI_FOREGROUND_CYAN, \
    ANSI_FOREGROUND_GREEN, ANSI_FOREGROUND_MAGENTA, ANSI_FOREGROUND_RED, ANSI_FOREGROUND_RESET, ANSI_FOREGROUND_YELLOW, \
    ANSI_FOREGROUND_LIGHT_RED, ANSI_FOREGROUND_LIGHT_GREEN, ANSI_FOREGROUND_LIGHT_YELLOW, ANSI_FOREGROUND_LIGHT_BLUE, \
